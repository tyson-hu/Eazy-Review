...
- One named task from `docs/TASKS.md` (for example "Task 7: Build Browse Screen With Mock Product List" or "Task 14: Real Browse And Product Detail Reads").
