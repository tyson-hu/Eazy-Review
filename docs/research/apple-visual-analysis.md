<!--
Archived visual research. This file is not an Eazy Review implementation
source of truth; use docs/DESIGN.md for product UI work.
-->
...
# Eazy Review UI Style

Visual style language for Eazy Review (photography-first surfaces, color, typography, elevation, do/don't). Product identity, principles, component rules, and screen-level UX live in `docs/DESIGN.md`. The app-canonical Visual System subset used in NativeWind and UI code is defined there and adapted from the tokens below.
