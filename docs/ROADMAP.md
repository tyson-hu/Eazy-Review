...
- Task 19: **Done — human accepted on 2026-08-30.** Caller-derived Edge
  ...
  **tested-pass** on `4c8ab7a`; acceptance included confirmation-clarity copy.
  PR #43 merged on 2026-08-30 as `ce2f6ec`; production remains separate.
  Post-acceptance branch closeout corrected signup confirmation to the exact
  two-slash app URL at `39c3927` without changing deletion acceptance
