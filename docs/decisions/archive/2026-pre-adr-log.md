...
> Archived on 2026-07-25 when the project adopted individual ADR-style
> decision records. This file preserves the complete pre-ADR log for historical
> context only. Current decisions are indexed in `docs/DECISIONS.md`; do not add
> new entries here.
