...
- `npm run check` (decision index, skill wrappers, routes, typecheck, lint, Expo doctor, dependency alignment) for route/dependency/skill changes or before handoff.
